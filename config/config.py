...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6874740506").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/rezmusicXbot/Rez-Music",
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/dns_support_group"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/dns_support_group")
